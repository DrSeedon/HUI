...
namespace UnityEditor
{
    ...
    internal class RuleTileEditor : Editor
    {
        ...
        {
            Handles.color = EditorGUIUtility.isProSkin ? new UnityEngine.Color(1f, 1f, 1f, 0.2f) : new UnityEngine.Color(0f, 0f, 0f, 0.2f);
            int index = 0;
            ...
            Handles.color = new UnityEngine.Color(1f, 1f, 1f, 1f);
        ...
        public override Texture2D RenderStaticPreview(string assetPath, Object[] subAssets, int width, int height)
        {
            if (tile.m_DefaultSprite != null)
            {
                ...
                if (t != null)
                {
                    ...
                    if (method != null)
                    {
                        object ret = method.Invoke("RenderStaticPreview", new object[] { tile.m_DefaultSprite, new UnityEngine.Color(1f, 1f, 1f, 1f), width, height });
                        if (ret is Texture2D)
